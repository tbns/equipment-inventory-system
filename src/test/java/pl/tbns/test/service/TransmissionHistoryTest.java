...
public class TransmissionHistoryTest extends TestCase{
	...
	public void setUp() {
		...
		equipmentDao.create(equipment1);
	...
	public void createTransmissionHistorTest(){
		Long equipmentId = equipmentDao.getAll().get(0).getId();
		Long sourceMagazineId = magazineDao.getAll().get(0).getId();
		Long destMagazineId = magazineDao.getAll().get(2).getId();
